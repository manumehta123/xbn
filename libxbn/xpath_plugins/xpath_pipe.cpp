...
xpathplugin_xbn_pipe::xpathplugin_xbn_pipe()
{
	min_parameter = 0;
	max_parameter = 2;
	name          = "xbn:|";
}
bool            xpathplugin_xbn_pipe::testUnit()
{
	return testPass( "1|2|3",3, xbnode::xbn_temp, "" );
}
bool            xpathplugin_xbn_pipe::operator() (xbn_state &state, xbn_xpath *pxpath )
{
	...
	state.addNodeList( arg1.ResultNodeList );
