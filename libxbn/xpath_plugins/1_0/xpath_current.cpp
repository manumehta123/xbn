...
xpathplugin_current::xpathplugin_current()
{
	min_parameter = 0;
	max_parameter = 0;
	name          = "current";
}
bool            xpathplugin_current::testUnit()
{
	return testPass( "/current()", 1, xbnode::xbn_root, "" );
}
bool           xpathplugin_current::operator() (xbn_state &state, xbn_xpath *pxpath )
{
