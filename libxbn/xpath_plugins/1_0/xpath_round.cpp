...
xpathplugin_round::xpathplugin_round()
{
	min_parameter = 1;
	max_parameter = 1;
	name          = "round";
...
bool            xpathplugin_round::operator() (xbn_state &state, xbn_xpath *pxpath )
{
			...
			++pc_arg1 )
	{
		...
		{
			double d = (*pc_arg1)->getNumeric();
			int c = (int)( d>=0? d+0.5 : d-0.5 );
